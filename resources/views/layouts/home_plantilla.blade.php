        ...
        <div class="row">
            <div class="col-2 px-1 bg-primary position-fixed" id="sticky-sidebar">
                <div class="text-center">
                    <div class="container">
                        <img class="img-fluid" src="{{ asset('img\logocr1.png') }}" width="175" height="175"
                ...
                <div class="nav flex-column flex-nowrap vh-100 overflow-auto text-white m-3">
                    ...
                    <a href="./" class="nav-link text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                            class="bi bi-file-text m-2" viewBox="0 0 16 16">
                            <path
                    ...
                    <a href="./" class="nav-link text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                            class="bi bi-journals m-2" viewBox="0 0 16 16">
                            <path
                    ...
                    <a href="./" class="nav-link text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                            class="bi bi-folder-plus m-2" viewBox="0 0 16 16">
                            <path
