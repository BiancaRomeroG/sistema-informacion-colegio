                ...
                <div class="nav flex-column flex-nowrap vh-100 overflow-auto text-white m-3">
                    <a href="/home" class="nav-link text-white my-1 py-0 px-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                            class="bi bi-house m-2" viewBox="0 0 16 16">
                    ...
                    @if (Auth::user()->id_rol == 1)
                        ...
                        <a href="./alumno" class="nav-link text-white my-1 py-0 px-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                class="bi bi-people mx-2 my-1" viewBox="0 0 16 16">
                                <path
                        ...
                        <a href="./alumno" class="nav-link text-white my-1 py-0 px-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                class="bi bi-pencil-square mx-2 my-1" viewBox="0 0 16 16">
                                <path
                        ...
                        <a href="./apoderado" class="nav-link text-white my-1 py-0 px-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                class="bi bi-person-rolodex mx-2 my-1" viewBox="0 0 16 16">
                        ...
                        <a href="./administrativo" class="nav-link text-white my-1 py-0 px-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                class="bi bi-person-workspace mx-2 my-1" viewBox="0 0 16 16">
                                <path
                        ...
                        <a href="./profesor" class="nav-link text-white my-1 py-0 px-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                class="bi bi-book mx-2 my-1" viewBox="0 0 16 16">
                                <path
                        ...
                        <a href="./cardex" class="nav-link text-white my-1 py-0 px-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                class="bi bi-journal-bookmark mx-2 my-1" viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
                        ...
                        <a href="./bitacora" class="nav-link text-white my-1 py-0 px-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                class="bi bi-newspaper mx-2 my-1" viewBox="0 0 16 16">
                                <path
                        ...
                        <a href="./curso" class="nav-link text-white my-1 py-0 px-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                class="bi bi-bookmark mx-2 my-1" viewBox="0 0 16 16">
                                <path
                        ...
                        <a href="./materia" class="nav-link text-white my-1 py-0 px-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                class="bi bi-journal-bookmark-fill mx-2 my-1" viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
                        ...
                        <a href="./boletin" class="nav-link text-white my-1 py-0 px-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                class="bi bi-briefcase mx-2 my-1" viewBox="0 0 16 16">
                                <path
                    ...
                    @elseif(Auth::user()->id_rol == 2)
                        ...
                        <a href="./inscripcion" class="nav-link text-white my-1 py-0 px-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-card-checklist  mx-2 my-1" viewBox="0 0 16 16">
                    ...
                    <form style="display: inline" action="{{ route('logout') }}" method="POST">
                        ...
                        <a href="#" onclick="this.closest('form').submit()" class="nav-link text-white my-1 py-0 px-1">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                class="bi bi-box-arrow-right m-2" viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
