...
<div class="row mb-3 justify-content-around">
    <div class="col m-2">
        ...
        <input class="form-control" id="codrude" type="number" name="codrude" value="{{old('codrude')}}" form="register_form">
    </div>
    <div class="col m-2">
        ...
        <option selected>Seleccione un Apoderado</option>
            ...
            <option value="{{$tutor->id}}"> {{$tutor->nombre}} {{$tutor->apellido_pat}} {{$tutor->apellido_mat}}</option>
            @endforeach
        </select>
