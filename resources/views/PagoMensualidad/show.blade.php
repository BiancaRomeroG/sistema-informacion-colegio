    ...
    <div class="col-10">
        <div class="card shadow m-5">
            <div class="card-header text-center">
                <h5 class="m-2">Pago Mensualidad</h5>
            </div>
                                ...
                                <div class="card-body">
                                    <div class="row justify-content-around">
                                        <div class="col m-2">
                                            ...
                                            <p class="mb-1"><b class="fw-bold  text-secondary">Parentesco: </b> {{$tutor->parentesco}}</p>
                                        </div>
                                        <div class="col m-2">
                                            <strong>Informacion</strong>
                                            <p class="mb-1 "><span class="fw-bold text-secondary">Cuota: </span> {{$pagoMen->nro_cuota}}° Mes</p>
